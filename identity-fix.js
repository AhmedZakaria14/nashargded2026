...
(function(){
  ...
  const TITLE='ELNASHARGROUP | وكالة تسويق رقمي في السعودية والخليج';
  const DESC='ELNASHARGROUP شريك نمو رقمي متكامل يقدم خدمات التسويق الرقمي، الإعلانات، تحسين محركات البحث، تصميم وتطوير المواقع، التجارة الإلكترونية والهوية الإبداعية في السعودية والخليج.';
  ...
  function patchMeta(){
    document.title=brandText(document.title||TITLE);
    if(!/ELNASHARGROUP/i.test(document.title)) document.title=TITLE;
    const set=(selector,value)=>{const el=document.querySelector(selector);if(el)el.setAttribute('content',value)};
    set('meta[name="description"]',DESC);
    set('meta[property="og:title"]',TITLE);
    set('meta[property="og:description"]',DESC);
    set('meta[property="og:site_name"]',BRAND);
    set('meta[property="og:url"]',SITE+location.pathname);
    set('meta[name="twitter:title"]',TITLE);
    set('meta[name="twitter:description"]',DESC);
    set('meta[name="application-name"]',BRAND);
    set('meta[name="apple-mobile-web-app-title"]',BRAND);
    set('meta[property="og:image"]',SITE+LOGO);
    set('meta[name="twitter:image"]',SITE+LOGO);
    const canonical=document.querySelector('link[rel="canonical"]');
    if(canonical)canonical.setAttribute('href',SITE+location.pathname);
  }
  ...
  function patchSchema(){
    ...
    if(document.querySelector('script[data-elnashar-schema]')) return;
    const s=document.createElement('script');
    s.type='application/ld+json';
    s.dataset.elnasharSchema='1';
